(function(root, factory) {
  ...
  function preview($ele) {
    var previewlink = $ele.attr("data--previewlink");
    var previewid = $ele.attr("data-previewid");
    $ele.find(".previewBtn").attr("id",previewid);
    var preview_url = 'https://view.officeapps.live.com/op/view.aspx?src=' + previewlink;
    //console.log(preview_url);
    // $ele.find("#" + previewid).on("click",function(){
    //   window.location.href = preview_url;//跳转
    // })
    $ele.find("#" + previewid).attr({ href: preview_url, target: "_blank" });
  }
